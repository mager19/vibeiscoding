...
- **Opcional pero recomendado**: Haber leído al menos un contrato de servicio o arrendamiento — no para entenderlo legalmente, sino para saber qué cláusulas buscar y construir mejores prompts de análisis.
...
- **Mentalidad**: El objetivo no es que la app "funcione" — es que funcione con contratos reales, con errores reales, y que tú entiendas por qué cada pieza está donde está.
- **Modo aprendizaje**: Al empezar, pídele a tu agente que explique cada decisión de arquitectura antes de implementarla. Si propone una librería o un patrón, pregunta por qué esa opción y no otra.
